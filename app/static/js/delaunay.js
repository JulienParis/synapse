...
(function(global) {
  ...
  function triangulate(vertices) {
    var triangles = [];
    // console.log("delaunay / vertices : ", vertices);
    //
    // First, create a "supertriangle" that bounds all vertices
    //
    var st = createBoundingTriangle(vertices);
    // console.log("delaunay / st : ", st);

    triangles.push(st);
    // console.log("delaunay / triangles.push(st) : ", triangles);
    ...
    // console.log("delaunay / vertices.forEach(function(vertex) : ", triangles);
  ...
  function addVertex(vertex, triangles) {
    ...
    // console.log("--- delaunay / edges :", edges  );
    return triangles;
  }
